...
public class LegoEv3PlayToneAction extends TemporalAction {
	...
	protected void update(float percent) {
		...
		Log.d("juc", "LegoEv3PlayToneAction | playTone params herz=" + hertzInterpretation + " | duration=" + durationInterpretation);

		ev3.playTone(hertzInterpretation, durationInterpretation * 1000, 100); //TODO: add volume InputField and so on...
	}
